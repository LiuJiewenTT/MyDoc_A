...
Relative Files: [Terrible Liquid](Terrible Liquid.md) or [Terrible Liquid]({{site.github.url}}{% for temppage in site.pages | where:"title", "Terrible Liquid" %}{{temppage.url}}{% endfor %})
